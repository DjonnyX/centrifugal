...
import { GradientColorPositions } from 'centrifugal';
 ...
 * @link https://github.com/DjonnyX/centrifugal/blob/main/src/app/components/x-substrate/x-substrate.component.ts
