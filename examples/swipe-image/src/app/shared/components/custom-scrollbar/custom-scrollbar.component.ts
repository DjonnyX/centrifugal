...
import { NtBaseSliderPublicService, SliderStates } from 'centrifugal';
 ...
 * @link https://github.com/DjonnyX/centrifugal/blob/20.x/src/app/components/custom-scrollbar/custom-scrollbar.component.ts
