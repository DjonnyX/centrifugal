...
import {
  NtListModule, INtListAnimationParams, Id, IDisplayObjectConfig, IScrollEvent, IVirtualListItem, NtListPublicService, IScrollingSettings,
  ItemTransformations, NtListComponent,
} from 'centrifugal';
...
@Component({
  ...
  imports: [
    CommonModule, ImageBoxComponent, NtListModule, PageLoadingIndicatorComponent, StaticClickDirective, CustomScrollbarModule,
  ],
  standalone: true,
