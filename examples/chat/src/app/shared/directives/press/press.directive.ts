...
const TOUCH_MOVE = 'touchmove', TOUCH_START = 'touchstart', TOUCH_END = 'touchend', TOUCH_LEAVE = 'touchleave',
    TOUCH_OUT = 'touchout', MOUSE_MOVE = 'mousemove', MOUSE_UP = 'mouseup', MOUSE_DOWN = 'mousedown', MOUSE_LEAVE = 'mouseleave', MOUSE_OUT = 'mouseout';
