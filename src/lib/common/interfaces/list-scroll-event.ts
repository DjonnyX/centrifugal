...
/**
 * Interface IListScrollEvent
 * @link https://github.com/DjonnyX/centrifugal/blob/main/src/lib/common/interfaces/list-scroll-event.ts
 * @author Evgenii Alexandrovich Grebennikov
 * @email djonnyx@gmail.com
 */
export interface IListScrollEvent {
    /**
     * Scroll area offset
     */
    scrollSize: number;
