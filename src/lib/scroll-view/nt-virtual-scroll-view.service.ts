...
import { IAnimationParams, IScrollOptions, IScrollViewService } from './interfaces';
...
export class NtVirtualScrollViewService implements IScrollViewService, OnDestroy {
