 ...
 * @link https://github.com/DjonnyX/centrifugal/blob/main/src/lib/scroll-view/nt-scroll-view.component.ts
 * @author Evgenii Alexandrovich Grebennikov
 * @email djonnyx@gmail.com
 */
@Component({
  selector: 'nt-scroll-view',
  templateUrl: './nt-scroll-view.component.html',
  styleUrl: './nt-scroll-view.component.scss',
  host: {
  ...
  constructor() {
    ...
    combineLatest([$scrollToInitialize, $scrollerComponent, $scrollTo]).pipe(
      ...
      tap(([, s, e]) => {
        ...
        s!.stopScrolling();
        s!.scroll({ x, y, left, top, behavior, blending, ease, duration, snap, userAction: true, onUpdate, onComplete });
      }),
    ).subscribe();
  }
