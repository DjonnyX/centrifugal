...
/**
 * NtDScrollView
 * @link https://github.com/DjonnyX/centrifugal/blob/main/src/lib/core/nt-d-scroller/nt-d-scroller/nt-d-scroller.component.ts
...
@Component({
  ...
  standalone: false,
  templateUrl: './nt-d-scroller.component.html',
  styleUrl: './nt-d-scroller.component.scss'
})
export class NtDScrollerComponent extends NtDScrollView {
