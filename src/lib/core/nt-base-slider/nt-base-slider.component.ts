 ...
 * @link https://github.com/DjonnyX/centrifugal/blob/main/src/lib/core/nt-base-slider/nt-base-slider.component.ts
...
export class NtBaseSliderComponent extends NtSScrollView {
